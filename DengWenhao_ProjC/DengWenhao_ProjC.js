...
g_MvpMat = new Matrix4();				// Changes CVV drawing axes to 'world' axes.
...
*/
  ...
  gouraudBox.init(gl);		//  "		"		"  for 1st kind of shading & lighting
	phongBox.init(gl);    //  "   "   "  for 2nd kind of shading & lighting
				...
				// TEMPORARY: set a global camera used by ALL VBObox objects...
...
var b4Wait = b4Draw - g_lastMS;
  ...
  if(g_show1 == 1) { // IF user didn't press HTML button to 'hide' VBO1:
	...
	if(g_show1 == 0) { // IF user didn't press HTML button to 'hide' VBO2:
...
// Called when user presses HTML-5 button 'Show/Hide VBO1'.
  ...
  document.getElementById('shade').innerHTML = g_show1 == 1 ? "Gouraud Shading" : "Phong Shading";
  console.log('g_show1: '+g_show1);
}
function turnlight() {
  if(tlig != 1) tlig = 1;     // show,
  else tlig = 0;                 // hide.
}
/*function VBO2toggle() {
//=============================================================================
...
// ALL VBObox objects.  REPLACE This with your own camera-control code.
  ...
  g_worldMat.lookAt( eyeX, eyeY, eyeZ,	// center of projection
...
// contains:  <body onload="main()" onresize="winResize()">
  ...
  var xtraMargin = 60;    // keep a margin (otherwise, browser adds scroll-bars)
