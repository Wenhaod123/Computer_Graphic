...
//  OpenGL's 'glGet()' becomes WebGL's 'getParameter()'
  ...
  g_modelMatrix.scale(0.35, 0.35, 0.35);
  						// if you DON'T scale, tetra goes outside the CVV; clipped!
  g_modelMatrix.rotate(g_angle04, 0, 1, 0);  // Make new drawing axes that
...
*/
	...
	g_modelMatrix.translate(g_xMdragTot*8, g_yMdragTot*8, 0.0);
...
//  if(angle <  -85.0 && g_angle01Rate < 0) g_angle01Rate = -g_angle01Rate;
  ...
  if(g_move < 0.1  && g_moveRate < 0) g_moveRate *= -1.0;
}
...
function decreaseRSpeed() {

  if(g_angle04Rate > 0) g_angle04Rate -= 45;;
...
// and report EVERYTHING on webpage:
  ...
  document.getElementById('KeyModResult' ).innerHTML = 
	...
	switch(kev.code) {
      ...
      break;
    case "KeyA":
      if(g_move2 >= 0.0) g_move2 = g_move2 - 0.3;
      break;
    case "KeyD":
      if(g_move2 <= 0.9) g_move2 = g_move2 + 0.3;
			break;
		//----------------Arrow keys------------------------
		case "ArrowLeft": 	
